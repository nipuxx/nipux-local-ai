...
- Launch profile generation exists for machine-specific env, commands, local launcher scripts, and clickable launcher files that use the local supervisor and open the private local UI.
