...
export const IMAGE_WORKER_URL = process.env.NIPUX_IMAGE_WORKER_URL ?? "";
export const SPEECH_WORKER_URL = process.env.NIPUX_SPEECH_WORKER_URL ?? "";
export const TRANSCRIPTION_WORKER_URL = process.env.NIPUX_TRANSCRIPTION_WORKER_URL ?? "";
export const VIDEO_WORKER_URL = process.env.NIPUX_VIDEO_WORKER_URL ?? "";
